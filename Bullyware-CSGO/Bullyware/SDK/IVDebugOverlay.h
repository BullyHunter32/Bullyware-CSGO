...
public:
	...
	virtual void AddCoordFrameOverlay(const void*& frame, float scale, int colorTable[3][3] = nullptr) = 0;
	...
	virtual void AddBoxOverlay2(const Vector& vecOrigin, const Vector& vecAbsMin, const Vector& vecAbsMax, const Vector& angOrientation, const void*& faceColor, const void*& edgeColor, float flDuration) = 0;
